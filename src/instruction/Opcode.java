...
public enum Opcode {
  ...
  /* Control */
  BEQ (OpcodeCategory.CONTROL, 3, 1),    /* beq  r1 r2 v1 = PC += {v1 if r1 =  r2, 1 otherwise} */
  BNE (OpcodeCategory.CONTROL, 3, 1),    /* bne  r1 r2 v1 = PC += {v1 if r1 != r2, 1 otherwise} */
  BGT (OpcodeCategory.CONTROL, 3, 1),    /* bgt  r1 r2 v1 = PC += {v1 if r1 >  r2, 1 otherwise} */
  BGE (OpcodeCategory.CONTROL, 3, 1),    /* bge  r1 r2 v1 = PC += {v1 if r1 >= r2, 1 otherwise} */
